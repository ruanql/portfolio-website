  ...
  return (
    ...
    className="mb-28 max-w-[50rem] text-center sm:mb-0 scroll-mt-[100rem]">
      ...
      >
        ...
        <span className="underline">React (Next.js) and Node.js projects</span>.
      </motion.h1>
      ...
      >
        ...
        <a
          ...
          outline-none focus:scale-110 hover:scale-105 active:scale-105 
          transition cursor-pointer borderBlack dark:bg-white/10"
          href="/Software_Engineer_Ruan.pdf"
          download
        >
          Download CV{" "}
